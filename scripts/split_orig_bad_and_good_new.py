...
ROOT = Path('preprocess')
ROOT.mkdir(exist_ok=True)


bads = json.load(open(ROOT/'orig_bad_code/final.bad.json'), object_pairs_hook=OrderedDict)
...
goods = json.load(open(ROOT/'orig_good_code/final.good.json'), object_pairs_hook=OrderedDict)
